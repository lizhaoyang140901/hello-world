...
function onMsgNotifyToUser(newMsgList,callback) {
    var newMsg;
    for (var j in newMsgList) {//遍历新消息
        newMsg = newMsgList[j];
        callback(sendToUser(newMsg));//处理新消息
    }
}
function sendToUser(msg){
...
module.exports = {
	...
	onMsgNotifyToUser:onMsgNotifyToUser,
