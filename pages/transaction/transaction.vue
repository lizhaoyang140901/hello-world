	...
	<view class="grandpa">
		<view class="son_first">
			<view class="son_first_top">
				...
				<view class="son_first_top_right" @click="jy_record">
		...
		<view class="son_two">
			<view class="son_two_left">
				<view class="son_two_left_one">
					<view class="son_two_left_one_zhang">做多</view>
					<view class="son_two_left_one_die">做空</view>
				</view>
				...
				<view class="son_two_left_three">
					<view class="son_two_left_three_top">杠杆</view>
					<view class="son_two_left_three_bottom">
						<u-radio-group v-model="dqsjvalue">
							<u-radio @change="radioChange" v-for="(item, index) in gglist" :key="index" active-color="#DE531E" :name="item.name"
							 :disabled="item.disabled">
								{{item.name}}
							</u-radio>
						</u-radio-group>
				...
				<view class="son_two_left_eight">
					<u-button type="success" @click="mmshow = true">创建杠杆</u-button>
				</view>
			</view>
